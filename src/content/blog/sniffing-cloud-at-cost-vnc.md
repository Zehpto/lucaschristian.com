...
![CaC Panel](/images/cloud_at_cost/panel.png)
...
![Console Capture](/images/cloud_at_cost/console_capture.png)
...
![WS Proxy](/images/cloud_at_cost/ws_proxy.png)
...
Probably the biggest reduction of possibilities is that "servername," "hostname," and "sshkey" are not actually required to authenticate as you can see below:

![Browser 1](/images/cloud_at_cost/browser.png)
...
![Console Prompt](/images/cloud_at_cost/console_prompt.png)
...
![Source Code](/images/cloud_at_cost/source_code.png)
...
![VNC Capture](/images/cloud_at_cost/vnc_capture.png)
...
![Key Logger](/images/cloud_at_cost/key_logger.png)
